    ...
    <div class="d-flex" id="wrapper" data-aos="fade-right">
      ...
      <div class="border-right" id="sidebar-wrapper">
        <div class="sidebar-heading text-center">
          <a href="{{ route('home') }}">
            <img src="/images/admin.png" alt="dashboard-store-logo" class="my-4" style="max-width: 120px;" />
          </a>
        </div>
      ...
      <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light navbar-store fixed-top" data-aos="fade-down">
          <div class="container-fluid">
            <button class="btn btn-outline-success d-md-none mr-auto mr-2" id="menu-toggle">
              &laquo; Menu
            </button>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <!-- Deskop Menu Profile & Cart -->
              <ul class="navbar-nav d-none d-lg-flex ml-auto">
                <li class="nav-item dropdown">
                  <a href="#" class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown">
                    <img src="/images/icon-user.png" alt="profile-user" class="rounded-circle mr-2 profile-picture" />
                    Hi, Rahmat
                  </a>
              ...
              <ul class="navbar-nav d-block d-lg-none">
                <li class="nav-item">
                  <a href="#" class="nav-link">Hi, Rahmat</a>
                </li>
                <li class="nav-item">
